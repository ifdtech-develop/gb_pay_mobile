...
import 'package:gb_pay_mobile/services/payment_card_dto.dart';
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate() || isLoading) {
                        var brandType = '';
                        if (numeroCartaoController.text.substring(0, 1) ==
                            "4") {
                          brandType = 'visa';
                        } else if (numeroCartaoController.text
                                .substring(0, 1) ==
                            "5") {
                        ...
                        CreditCardPreferencs.setSecurityCode(
                            cvvController.text);
                        ...
                        CreditCardPreferencs.setAmountDouble(
                            valueAmount[installment - 1]);
                        CreditCardPreferencs.setAmountOrigin(widget.valor);
                        CreditCardPreferencs.setDocumentNumber(
                            '76600763000135');
                        CreditCardPreferencs.setCardHolderDocumentUnformated(
                            cpfCnpjController.text);
                        CreditCardPreferencs.setInstallments(
                            installment.toInt());
                        widget.navigator
                            .pushNamed(AppRouteNames.paymentLocation);
